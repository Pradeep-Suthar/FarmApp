...
import com.example.farmapp.Helper.SelectImageHelper;
...
public class SignUpActivity extends AppCompatActivity {
    ...
    EditText RegeditTextName, RegeditTextEmail, RegeditTextMobile, RegeditTextPwd, RegeditTextCPwd,RegeditTextCityPin;
    Button btnSignUp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RegeditTextName = findViewById(R.id.regName);
        RegeditTextEmail = findViewById(R.id.regEmail);
        RegeditTextMobile = findViewById(R.id.regMobile);
        RegeditTextPwd = findViewById(R.id.regPwd);
        RegeditTextCPwd = findViewById(R.id.regCPwd);
        btnSignUp = findViewById(R.id.buttonsignup);
        textViewClickReg = findViewById(R.id.textClickReg);
        RegeditTextCityPin=findViewById(R.id.regCityPin);
    ...
    public void getSignUp() {
        ...
        final String cityPin=RegeditTextCityPin.getText().toString();
        ...
        }else if(cityPin.length()==0){
            RegeditTextCityPin.setError("please enter City Pin Code");
            RegeditTextCityPin.requestFocus();
            progressDialog.cancel();
        }else if(cityPin.length()<6){
            RegeditTextCityPin.setError("please enter Valid City Pin Code");
            RegeditTextCityPin.requestFocus();
            progressDialog.cancel();
